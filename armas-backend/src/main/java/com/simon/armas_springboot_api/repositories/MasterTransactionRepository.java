...
public interface MasterTransactionRepository extends JpaRepository<MasterTransaction, Integer> {
       ...
       List<MasterTransaction> findByTransactionDocumentId(
                     @Param("transactionDocumentId") String transactionDocumentId);
       ...
       List<MasterTransaction> findApproverTasks(@Param("userId") Long userId,
                     @Param("statuses") List<String> statuses);
       ...
       List<MasterTransaction> findByReportstatusAndSubmittedByAuditor(@Param("reportstatus") String reportstatus,
                     @Param("submittedByAuditor") User submittedByAuditor);
       ...
       long countSendersByReportTypeAndFiscalYear(@Param("reportype") String reportype,
                     @Param("fiscalYear") String fiscalYear);
