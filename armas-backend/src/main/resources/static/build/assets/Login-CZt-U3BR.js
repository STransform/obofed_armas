import{r as c,a1 as v,a2 as j,j as e,a5 as C}from"./index-CO8IFFyo.js";import{g as N,c as p,d as i,f as x,a as m}from"./index.esm-BiLQHBMC.js";import{C as y,a as k,b as E}from"./CForm--Mlf6NR6.js";import{C as h,a as g}from"./CInputGroupText-Db8zzmRc.js";const S=()=>{const[s,u]=c.useState({username:"",password:""}),[l,o]=c.useState(""),r=v(),{loginAction:f}=j(),b=async t=>{if(t.preventDefault(),o(""),!s.username||!s.password){o("Please enter both username and password");return}try{const a=await f(s);console.log("User roles after login:",a),a.includes("ADMIN")?r("/charts"):a.includes("USER")||a.includes("SENIOR_AUDITOR")||a.includes("ARCHIVER")||a.includes("APPROVER")||a.includes("MANAGER")?r("/charts/"):r("/#")}catch(a){const n=a.message||"Login failed. Please try again.";o(n),console.error("Login error:",a)}},d=t=>{const{name:a,value:n}=t.target;u(w=>({...w,[a]:n}))};return e.jsxs("div",{style:{backgroundColor:"#2B547E",minHeight:"100vh",position:"relative",overflow:"hidden"},children:[e.jsx("style",{children:`
          .login-form {
            width: 700px;
            margin: 100px auto;
